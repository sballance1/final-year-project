...
```
cd existing_repo
git remote add origin https://gitlab.cs.nuim.ie/u230320/finalyearproject.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.nuim.ie/u230320/finalyearproject/-/settings/integrations)
...
I have downloaded node in my editor.
